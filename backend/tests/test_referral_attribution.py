...
from backend.models import ReferralAttribution, ReferralCode
from backend.services.loyalty import attach_referral_to_customer
...
class FakeSession:
    def __init__(self, *, referral=None, attribution=None):
...
def test_same_referral_retry_is_idempotent():

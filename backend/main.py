...
from . import catalog_demand_models as _catalog_demand_models  # noqa: F401
...
from .api.catalog_demand import router as catalog_demand_router
...
app.include_router(catalog_demand_router, prefix="/api")
